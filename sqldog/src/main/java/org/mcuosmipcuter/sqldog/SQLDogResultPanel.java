...
public class SQLDogResultPanel extends JPanel implements SQLDogWorkSpacePersistence,
                                                            SQLDogResultProcessor.ColSizeListener,
                                                        SQLDogResultProcessor.FindListener,
                                                    SQLDogResultProcessor.SaveListener
{
	public static final String WS_VERSION	= "1.1";
    java.awt.Point findPoint = new java.awt.Point(0, 1);
	SQLDogController controller;
    MouseListener mouseListener;
    SQLDogResultProcessor.TableModel currentTableModel;
	String windowRows = SQLDogConstants.INITIAL_WINDOW_ROWS;
  ...
  JCheckBox ckMatchCase = new JCheckBox();
	...
	public SQLDogResultPanel(SQLDogController controller, MouseListener mouseListener)
	{
	...
	{
		taMessage.setBackground(SQLDogConstants.COLOR_ERROR);
        e.printStackTrace();
	...
	{
		taMessage.setBackground(SQLDogConstants.COLOR_ALRIG);
    ...
    {
        setEnabled(false);
        taMessage.setBackground(SQLDogConstants.COLOR_DISCONNECTED);
        appendMessage(message);
    }
	...
	private void appendMessage(String message)
	{
		taMessage.setText(taMessage.getText() + "\n" + (new Date())
												+ SQLDogConstants.MESSAGE_SEP + message);
    ...
    public void setResult(SQLDogResultProcessor.TableModel model)
    {
    ...
    public void setMinColumnWidths(boolean alsoPreferred)
    {
        ...
        SQLDogResultProcessor.TableModel model = (SQLDogResultProcessor.TableModel)resTable.getModel();
        if(model.getColumnCount() > 0)
        {
    ...
    public void setColumnWidths()
        {
            ...
            {
                if(resTable.getModel() instanceof SQLDogResultProcessor.TableModel)
                {
                    SQLDogResultProcessor.TableModel model = (SQLDogResultProcessor.
	...
	{
		if(	workSpace == null
			|| !(workSpace instanceof SQLDogResultPanelWorkSpace))
			return;

		SQLDogResultPanelWorkSpace ws = (SQLDogResultPanelWorkSpace)workSpace;
	...
	{
		return  new SQLDogResultPanelWorkSpace(	tfFind.getText(),
  ...
  private void jbInit() throws Exception {
    ...
    taMessage.setText("");
    taMessage.addMouseListener(new SQLDogResultPanel_taMessage_mouseAdapter(this));
    ...
    /**@todo SQLDogResultPanel_outWindow_mouseAdapter(this)); */
    ...
    ckSizeColumns.addActionListener(new SQLDogResultPanel_ckSizeColumns_actionAdapter(this));
    ...
    tfFind.setText("");
    tfFind.addCaretListener(new SQLDogResultPanel_tfFind_caretAdapter(this));
    ...
    btnFind.addActionListener(new SQLDogResultPanel_btnFind_actionAdapter(this));
    /**@todo SQLDogResultPanel_outWindow1_mouseAdapter(this)); */
    ...
    resTable.addMouseListener(new SQLDogResultPanel_resTable_mouseAdapter(this));
    ...
    btnResInfo.addActionListener(new SQLDogResultPanel_btnResInfo_actionAdapter(this));
    ...
    btnStop.addActionListener(new SQLDogResultPanel_btnStop_actionAdapter(this));
    ...
    ckExpandLobs.setMnemonic('E');
        ...
        ckExpandLobs.addActionListener(new SQLDogResultPanel_ckExpandLobs_actionAdapter(this));
	ckRegex.setOpaque(false);
	ckRegex.setMnemonic('G');
	ckRegex.setText("regex");
	ckRegex.addActionListener(new SQLDogResultPanel_ckRegex_actionAdapter(this));
...
resTable.repaint();
  ...
  public void panelSaveCsv()
   {
       ...
       //tfFind.setBackground(SQLDogConstants.COLOR_DISCONNECTED);
       progBar.setForeground(new Color(155, 125, 245));
  ...
  public void onFindResult(Point foundAt)
  {
      ...
      resTable.setToolTipText("result");
      btnFind.setEnabled(true);
      progBar.setForeground(SQLDogConstants.COLOR_DISCONNECTED);
      findPoint = foundAt;
      //System.out.println("findPoint:" + findPoint);
          ...
          if (!(findPoint.x == 0 && findPoint.y == 1))
          {
              ...
              tfFind.setBackground(SQLDogConstants.COLOR_ALRIG);
            resTable.repaint();
            getToolkit().beep();
          }
          else
          {
              tfFind.setBackground(SQLDogConstants.COLOR_ERROR);
          }
...
class SQLDogResultPanel_ckSizeColumns_actionAdapter implements java.awt.event.ActionListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_ckSizeColumns_actionAdapter(SQLDogResultPanel adaptee) {
...
class SQLDogResultPanel_btnFind_actionAdapter implements java.awt.event.ActionListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_btnFind_actionAdapter(SQLDogResultPanel adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class SQLDogResultPanel_tfFind_caretAdapter implements javax.swing.event.CaretListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_tfFind_caretAdapter(SQLDogResultPanel adaptee) {
    this.adaptee = adaptee;
  }
...
class SQLDogResultPanel_taMessage_mouseAdapter extends java.awt.event.MouseAdapter
{
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_taMessage_mouseAdapter(SQLDogResultPanel adaptee)
  {
    this.adaptee = adaptee;
  }
...
class SQLDogResultPanel_resTable_mouseAdapter extends java.awt.event.MouseAdapter
{
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_resTable_mouseAdapter(SQLDogResultPanel adaptee)
  {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e)
...
class SQLDogResultPanel_btnResInfo_actionAdapter implements java.awt.event.ActionListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_btnResInfo_actionAdapter(SQLDogResultPanel adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class SQLDogResultPanel_btnStop_actionAdapter implements java.awt.event.ActionListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_btnStop_actionAdapter(SQLDogResultPanel adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class SQLDogResultPanel_ckExpandLobs_actionAdapter implements java.awt.event.ActionListener {
  SQLDogResultPanel adaptee;

  SQLDogResultPanel_ckExpandLobs_actionAdapter(SQLDogResultPanel adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class SQLDogResultPanel_ckRegex_actionAdapter
	implements ActionListener
{

	SQLDogResultPanel_ckRegex_actionAdapter(SQLDogResultPanel adaptee)
	{
		this.adaptee = adaptee;
	}
