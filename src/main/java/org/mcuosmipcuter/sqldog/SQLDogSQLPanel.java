...
import org.mcuosmipcuter.sqldog.editor.CStyleCommentedDocument;
import org.mcuosmipcuter.sqldog.editor.HighlightingUI;
import org.mcuosmipcuter.sqldog.editor.SyntaxPainter;
//import com.borland.jbcl.layout.*;

public class SQLDogSQLPanel extends JPanel implements SQLDogWorkSpacePersistence,
//FocusListener,
AdjustmentListener
{
  ...
  //org.mcuosmipcuter.sqldog.editor.TestTextArea sqlWindow;
  /////
          ...
          SyntaxPainter.DrillDownInitListener()
      {
          public void tryDrillDown(String token, int pos)
          {
              ...
              if(getCaretPosition() == pos)
              {
                  ...
                  if (objTree.getModel()instanceof SQLDogDBMetaObjects)
                  {
                      System.out.println("__ instanceof SQLDogDBMetaObjects __");
                      SQLDogDBMetaObjects mo = (SQLDogDBMetaObjects)
                          objTree.getModel();
...
*/
  ...
  public SQLDogSQLPanel(MouseListener mouseListener, SQLDogFrame frame)
  {
    this.mouseListener = mouseListener;
	this.frame = frame;
      ResourceBundle bundle = ResourceBundle.getBundle("org.mcuosmipcuter.sqldog.editor/sql92",
...
*/
	...
	{
		if(	workSpace == null
			|| !(workSpace instanceof SQLDogSQLPanelWorkSpace))
			return;

		SQLDogSQLPanelWorkSpace ws = (SQLDogSQLPanelWorkSpace)workSpace;
	...
	public SQLDogWorkSpace getWorkSpace()
	{
		...
		return  new SQLDogSQLPanelWorkSpace(WS_VERSION, sqlWindow.getText(),
                                            splitPane.getDividerLocation(),
                                            splitPane2.getDividerLocation());
	}
    public void setObjTreeModel(SQLDogDBMetaObjects mo)
    {
        objTree.setModel(mo);
  ...
  private void jbInit() throws Exception {
    ...
    sqlWindow.setRows(0);
    sqlWindow.addMouseListener(new SQLDogSQLPanel_sqlWindow_mouseAdapter(this));
    sqlWindow.addFocusListener(new SQLDogSQLPanel_sqlWindow_focusAdapter(this));
    ...
    scratchWindow.addMouseListener(new SQLDogSQLPanel_scratchWindow_mouseAdapter(this));
    ...
    objTree.setScrollsOnExpand(true);
        objTree.addMouseListener(new SQLDogSQLPanel_objTree_mouseAdapter(this));
  ...
  /*
    ...
    class MyRenderer extends DefaultTreeCellRenderer
    {
      ...
      public Component getTreeCellRendererComponent(
          ...
          java.net.URL url = getClass().getResource(SQLDogConstants.ICON_PATH + gifBaseName + ".gif");
          if(url != null)
          {
...
class SQLDogSQLPanel_sqlWindow_focusAdapter extends java.awt.event.FocusAdapter {
  SQLDogSQLPanel adaptee;

  SQLDogSQLPanel_sqlWindow_focusAdapter(SQLDogSQLPanel adaptee) {
...
class SQLDogSQLPanel_sqlWindow_mouseAdapter extends java.awt.event.MouseAdapter
{
  SQLDogSQLPanel adaptee;

  SQLDogSQLPanel_sqlWindow_mouseAdapter(SQLDogSQLPanel adaptee)
  {
    this.adaptee = adaptee;
  }
...
class SQLDogSQLPanel_scratchWindow_mouseAdapter extends java.awt.event.MouseAdapter
{
  SQLDogSQLPanel adaptee;

  SQLDogSQLPanel_scratchWindow_mouseAdapter(SQLDogSQLPanel adaptee)
  {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e)
...
class SQLDogSQLPanel_objTree_mouseAdapter extends java.awt.event.MouseAdapter
{
    SQLDogSQLPanel adaptee;

    SQLDogSQLPanel_objTree_mouseAdapter(SQLDogSQLPanel adaptee)
    {
        this.adaptee = adaptee;
    }
    public void mouseReleased(MouseEvent e)
