...
public class VeritcalSplitPaneWorkSpace implements WorkSpace
{
	private long created;
	private int dividerPosition;

    public VeritcalSplitPaneWorkSpace()
    {

    }
	public VeritcalSplitPaneWorkSpace(int dividerPosition)
	{
	...
	{
		if(!(obj instanceof VeritcalSplitPaneWorkSpace))
			return false;
		VeritcalSplitPaneWorkSpace sp = (VeritcalSplitPaneWorkSpace)obj;
		// non basic checks
