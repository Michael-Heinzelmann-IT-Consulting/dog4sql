...
/**
 * <p>Title: Login window for Dog4SQL</p>
...
{
    /**
     * Constants.WINDOW_TITLE_NOT_CONNECTED concatenated with "Login"
     */
    public final static String TITLE = Constants.
     ...
     * <br/>will be set in setVisible(), should contain only Constants
     */
    String task;
  ...
  JCheckBox ckLoadMetadataOnConnect = new JCheckBox();
    ...
    {
        LoginWindow Dog4SQLLoginWindow1 = new LoginWindow();
        Dog4SQLLoginWindow1.setVisible(true);
    }

    public static Hashtable getDefaultLogins()
    {
        Hashtable hashTable = new Hashtable();
        for (int i = 0; i < Constants.DEFAULT_LOGINS.length; i++)
        {
            hashTable.put( ( (Login) Constants.DEFAULT_LOGINS[i]).
                          getName(),
                          Constants.DEFAULT_LOGINS[i]);
        }
        return hashTable;
    }
    ...
    tfName.setToolTipText("alias name for the connection");
        ...
        tfName.addCaretListener(new Dog4SQLLoginWindow_tfName_caretAdapter(this));
    ...
    tfDriver.setToolTipText("full qualified class name of driver");
        ...
        tfDriver.addCaretListener(new Dog4SQLLoginWindow_tfDriver_caretAdapter(this));
        tfDriver.addCaretListener(new Dog4SQLLoginWindow_tfDriver_caretAdapter(this));
    ...
    panel3.setOpaque(false);
        ...
        tfUrl.addCaretListener(new Dog4SQLLoginWindow_tfUrl_caretAdapter(this));
    ...
    panel4.setOpaque(false);
        ...
        tfUsername.addCaretListener(new Dog4SQLLoginWindow_tfUsername_caretAdapter(this));
    ...
    panel5.setOpaque(false);
        ...
        tfPassword.addCaretListener(new Dog4SQLLoginWindow_tfPassword_caretAdapter(this));
    ...
    cancelButton.addActionListener(new Dog4SQLLoginWindow_cancelButton_actionAdapter(this));
    cancelButton.addActionListener(new Dog4SQLLoginWindow_cancelButton_actionAdapter(this));
    cancelButton.addActionListener(new
            Dog4SQLLoginWindow_cancelButton_actionAdapter(this));
    ...
    closeButton.addActionListener(new Dog4SQLLoginWindow_closeButton_actionAdapter(this));
    closeButton.addActionListener(new Dog4SQLLoginWindow_closeButton_actionAdapter(this));
    closeButton.addActionListener(new
            Dog4SQLLoginWindow_closeButton_actionAdapter(this));
    ...
    saveButton.addActionListener(new Dog4SQLLoginWindow_saveButton_actionAdapter(this));
    saveButton.addActionListener(new Dog4SQLLoginWindow_saveButton_actionAdapter(this));
    saveButton.addActionListener(new Dog4SQLLoginWindow_saveButton_actionAdapter(this));
    saveButton.addActionListener(new
                                     Dog4SQLLoginWindow_saveButton_actionAdapter(this));
    ...
    connectButton.addActionListener(new Dog4SQLLoginWindow_connectButton_actionAdapter(this));
    connectButton.addActionListener(new Dog4SQLLoginWindow_connectButton_actionAdapter(this));
    connectButton.addActionListener(new Dog4SQLLoginWindow_connectButton_actionAdapter(this));
    connectButton.addActionListener(new
            Dog4SQLLoginWindow_connectButton_actionAdapter(this));
    ...
    ckLoadMetadataOnConnect.addChangeListener(new Dog4SQLLoginWindow_ckLoadMetadataOnConnect_changeAdapter(this));
    ...
    {
        return new Login(tfName.getText(),
                               tfDriver.getText(),
                               tfUrl.getText(),
                               tfUsername.getText(),
    ...
    void connectButton_actionPerformed(ActionEvent e)
    {
        actionListener.actionPerformed(new ActionEvent(this,
            ...
            Constants.LOGIN_CONNECT));
        if (task.equals(Constants.CONNECT))
        {
            setVisible(false);
        }
    }
...
class Dog4SQLLoginWindow_tfName_caretAdapter
    implements javax.swing.event.CaretListener
{
    LoginWindow adaptee;

    Dog4SQLLoginWindow_tfName_caretAdapter(LoginWindow adaptee)
    {
...
class Dog4SQLLoginWindow_tfDriver_caretAdapter implements javax.swing.event.CaretListener
{
    LoginWindow adaptee;

    Dog4SQLLoginWindow_tfDriver_caretAdapter(LoginWindow adaptee)
    {
        this.adaptee = adaptee;
    }
    public void caretUpdate(CaretEvent e)
...
class Dog4SQLLoginWindow_tfUrl_caretAdapter implements javax.swing.event.CaretListener
{
    LoginWindow adaptee;

    Dog4SQLLoginWindow_tfUrl_caretAdapter(LoginWindow adaptee)
    {
        this.adaptee = adaptee;
    }
    public void caretUpdate(CaretEvent e)
...
class Dog4SQLLoginWindow_tfUsername_caretAdapter implements javax.swing.event.CaretListener
{
    LoginWindow adaptee;

    Dog4SQLLoginWindow_tfUsername_caretAdapter(LoginWindow adaptee)
    {
        this.adaptee = adaptee;
    }
    public void caretUpdate(CaretEvent e)
...
class Dog4SQLLoginWindow_tfPassword_caretAdapter implements javax.swing.event.CaretListener
{
    LoginWindow adaptee;

    Dog4SQLLoginWindow_tfPassword_caretAdapter(LoginWindow adaptee)
    {
        this.adaptee = adaptee;
    }
    public void caretUpdate(CaretEvent e)
...
class Dog4SQLLoginWindow_closeButton_actionAdapter implements java.awt.event.ActionListener {
  LoginWindow adaptee;

  Dog4SQLLoginWindow_closeButton_actionAdapter(LoginWindow adaptee) {
    this.adaptee = adaptee;
  }
...
class Dog4SQLLoginWindow_cancelButton_actionAdapter implements java.awt.event.ActionListener {
  LoginWindow adaptee;

  Dog4SQLLoginWindow_cancelButton_actionAdapter(LoginWindow adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLLoginWindow_connectButton_actionAdapter implements java.awt.event.ActionListener {
  LoginWindow adaptee;

  Dog4SQLLoginWindow_connectButton_actionAdapter(LoginWindow adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLLoginWindow_saveButton_actionAdapter implements java.awt.event.ActionListener {
  LoginWindow adaptee;

  Dog4SQLLoginWindow_saveButton_actionAdapter(LoginWindow adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLLoginWindow_ckLoadMetadataOnConnect_changeAdapter implements javax.swing.event.ChangeListener {
  LoginWindow adaptee;

  Dog4SQLLoginWindow_ckLoadMetadataOnConnect_changeAdapter(LoginWindow adaptee) {
    this.adaptee = adaptee;
  }
