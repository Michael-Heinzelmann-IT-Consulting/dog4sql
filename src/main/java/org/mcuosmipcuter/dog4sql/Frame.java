...
class Frame extends JFrame implements  ActionListener
{
  ...
  JMenuItem jMenuItemAbout = new JMenuItem();
	...
	public Frame()
	{
		...
		controller = new Controller(mouseAdapter, this);
		boolean restored = controller.restoreWorkSpaces();
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle(Constants.WINDOW_TITLE_NOT_CONNECTED);
...
/////
  private void jbInit() throws Exception
  {
    ...
    mniItalic.addActionListener(new Frame1_mniItalic_actionAdapter(this));
    jPopupMenu1.setBackground(Constants.COLOR_APP);
    ...
    mniBold.addActionListener(new Frame1_mniBold_actionAdapter(this));
    mniPlain.addActionListener(new Frame1_mniPlain_actionAdapter(this));
    mniPlain.setBackground(Constants.COLOR_APP);
    mniPlain.setOpaque(true);
    mniPlain.setText("plain");
    mniBold.setBackground(Constants.COLOR_APP);
    mniBold.setOpaque(true);
    mniBold.setText("bold");
    mniItalic.setBackground(Constants.COLOR_APP);
    mniItalic.setOpaque(true);
    mniItalic.setText("italic");
    jMenuStyle.setBackground(Constants.COLOR_APP);
    ...
    jMenu2.setBackground(Constants.COLOR_APP);
        jMenu2.setMnemonic('0');
    jMenu2.setText("font size");
    rbm6.setBackground(Constants.COLOR_APP);
    rbm6.setOpaque(true);
    rbm6.setText("6");
    rbm6.addActionListener(new Dog4SQLFrame_rbm6_actionAdapter(this));
    rbm8.setBackground(Constants.COLOR_APP);
    rbm8.setText("8");
    rbm8.addActionListener(new Dog4SQLFrame_rbm8_actionAdapter(this));
    rbm10.setBackground(Constants.COLOR_APP);
    rbm10.setText("10");
    rbm10.addActionListener(new Dog4SQLFrame_rbm10_actionAdapter(this));
    rbm12.setBackground(Constants.COLOR_APP);
    rbm12.setText("12");
    rbm12.addActionListener(new Dog4SQLFrame_rbm12_actionAdapter(this));
    rbm14.setBackground(Constants.COLOR_APP);
    rbm14.setText("14");
    rbm14.addActionListener(new Dog4SQLFrame_rbm14_actionAdapter(this));
    rbm16.setBackground(Constants.COLOR_APP);
    rbm16.setText("16");
    rbm16.addActionListener(new Dog4SQLFrame_rbm16_actionAdapter(this));
    ...
    jMenuItemSelAll.setMnemonic('0');
        ...
        jMenuItemSelAll.addMouseListener(new Dog4SQLFrame_jMenuItemSelAll_mouseAdapter(this));
        menuItemFind.setOpaque(false);
        menuItemFind.setMnemonic('0');
    menuItemFind.setText("find");
    menuItemFind.addMouseListener(new Dog4SQLFrame_menuItemFind_mouseAdapter(this));
    menuItemFindNext.setOpaque(false);
        menuItemFindNext.setMnemonic('0');
    menuItemFindNext.setText("find next");
    menuItemFindNext.addMouseListener(new Dog4SQLFrame_menuItemFindNext_mouseAdapter(this));
        menuItemResultTable.setOpaque(false);
    menuItemResultTable.setText("SQL result");
    sbmCopyHeaderNames.setBackground(Constants.COLOR_APP);
    sbmCopyHeaderNames.setOpaque(true);
    sbmCopyHeaderNames.setText("copy header names");
    sbmCopyHeaderNames.addMouseListener(new Dog4SQLFrame_sbmCopyHeaderNames_mouseAdapter(this));
    sbmSaveAsCsv.setBackground(Constants.COLOR_APP);
        sbmSaveAsCsv.setText("save as CSV");
        sbmSaveAsCsv.addMouseListener(new Dog4SQLFrame_sbmSaveAsCsv_mouseAdapter(this));
        menuItemReload.setOpaque(false);
    menuItemReload.setText("reload metadata");
        menuItemReload.addMouseListener(new Dog4SQLFrame_menuItemReload_mouseAdapter(this));
    jMenuFile.setOpaque(false);
    jMenuFile.setMnemonic('F');
    jMenuFile.setText("File");
    jMenuItemExit.setBackground(Constants.COLOR_APP);
    jMenuItemExit.setMnemonic('E');
    jMenuItemExit.setText("Exit");
    jMenuItemExit.addActionListener(new Dog4SQLFrame_jMenuItemExit_actionAdapter(this));
    jMenuSettings.setOpaque(false);
    jMenuSettings.setMnemonic('S');
    jMenuSettings.setText("Settings");
    jMenuItemGeneral.setBackground(Constants.COLOR_APP);
    jMenuItemGeneral.setMnemonic('G');
    jMenuItemGeneral.setText("general");
    jMenuItemDrivers.setBackground(Constants.COLOR_APP);
    jMenuItemDrivers.setMnemonic('J');
    jMenuItemDrivers.setText("JDBC drivers");
    jMenuItemDrivers.addActionListener(new Dog4SQLFrame_jMenuItemDrivers_actionAdapter(this));
    jMenuHelp.setOpaque(false);
    jMenuHelp.setMnemonic('H');
    jMenuHelp.setText("Help");
    jMenuItemAbout.setBackground(Constants.COLOR_APP);
    jMenuItemAbout.setMnemonic('A');
    jMenuItemAbout.setText("about");
    jMenuItemAbout.addActionListener(new Dog4SQLFrame_jMenuItemAbout_actionAdapter(this));
    jMenuBar1.setBackground(Constants.COLOR_APP);
    jMenuBar1.setOpaque(true);
        rbm18.setBackground(Constants.COLOR_APP);
    rbm18.setText("18");
    rbm18.addActionListener(new Dog4SQLFrame_rbm18_actionAdapter(this));
  ...
  private void popUp(MouseEvent e)
  {
   ...
   //menuItemResultTable.setEnabled(popper instanceof ResultPanel.MyJTable);
   if(popper instanceof ResultPanel.MyJTable)
   {
    ...
    if(popper instanceof SQLPanel.MyJTree)
        menuItemReload.setEnabled(((SQLPanel.MyJTree)popper).getReloadState());
  ...
  void sbmCopyHeaderNames_mouseReleased(MouseEvent e) {
      ((ResultPanel.MyJTable)popper).copyHeaderNames();
  }

    void sbmSaveAsCsv_mouseReleased(MouseEvent e) {
        ((ResultPanel.MyJTable)popper).saveCsv();
    }
...
class Frame1_mniItalic_actionAdapter implements java.awt.event.ActionListener
{
  ...
  Frame1_mniItalic_actionAdapter(Frame adaptee)
  {
...
class Frame1_mniBold_actionAdapter implements java.awt.event.ActionListener
{
  ...
  Frame1_mniBold_actionAdapter(Frame adaptee)
  {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e)
...
class Frame1_mniPlain_actionAdapter implements java.awt.event.ActionListener
{
  ...
  Frame1_mniPlain_actionAdapter(Frame adaptee)
  {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e)
...
class Dog4SQLFrame_rbm6_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm6_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm8_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm8_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm10_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm10_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm12_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm12_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm14_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm14_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm16_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm16_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_rbm18_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_rbm18_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_jMenuItemSelAll_mouseAdapter extends java.awt.event.MouseAdapter
{
    Frame adaptee;

    Dog4SQLFrame_jMenuItemSelAll_mouseAdapter(Frame adaptee)
    {
        this.adaptee = adaptee;
    }
    public void mouseReleased(MouseEvent e)
...
class Dog4SQLFrame_menuItemFind_mouseAdapter extends java.awt.event.MouseAdapter {
  Frame adaptee;

  Dog4SQLFrame_menuItemFind_mouseAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e) {
...
class Dog4SQLFrame_menuItemFindNext_mouseAdapter extends java.awt.event.MouseAdapter {
  Frame adaptee;

  Dog4SQLFrame_menuItemFindNext_mouseAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e) {
...
class Dog4SQLFrame_sbmCopyHeaderNames_mouseAdapter extends java.awt.event.MouseAdapter {
  Frame adaptee;

  Dog4SQLFrame_sbmCopyHeaderNames_mouseAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e) {
...
class Dog4SQLFrame_sbmSaveAsCsv_mouseAdapter extends java.awt.event.MouseAdapter {
  Frame adaptee;

  Dog4SQLFrame_sbmSaveAsCsv_mouseAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e) {
...
class Dog4SQLFrame_menuItemReload_mouseAdapter extends java.awt.event.MouseAdapter {
  Frame adaptee;

  Dog4SQLFrame_menuItemReload_mouseAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseReleased(MouseEvent e) {
...
class Dog4SQLFrame_jMenuItemExit_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_jMenuItemExit_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_jMenuItemDrivers_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_jMenuItemDrivers_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Dog4SQLFrame_jMenuItemAbout_actionAdapter implements java.awt.event.ActionListener {
  Frame adaptee;

  Dog4SQLFrame_jMenuItemAbout_actionAdapter(Frame adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
