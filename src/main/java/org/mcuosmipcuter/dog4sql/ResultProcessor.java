...
import org.mcuosmipcuter.dog4sql.adt.ObjectCache;
...
class ResultProcessor
{
	...
	public ResultProcessor(ResultWrapper rw, QueryListener ql, ColSizeListener cl)
	{
		this.rw = rw;
        this.ql = ql;
        this.cl = cl;
    ...
    {
        Controller.trace(5, "stopping save");
        saveRuns = false;
    }

    public void stopCopyAll()
    {
        Controller.trace(5, "stopping select all");
        copyRuns = false;
    }

    public void stopFind()
    {
        Controller.trace(5, "stopping find");
        findRuns = false;
    }
    ...
    public class Finder extends Thread
    {
        ...
        {
            findRuns = true;
            Controller.trace(4, this + " starting");
            System.out.println();
            findInResult();
            Controller.trace(4, this + " returning");
            findRuns = false;
        }

        public void findInResult()
        {
            Controller.trace(4, "finding '" + what + "' from " + start);
                ...
                try
                {
                    ...
                    for(int r = start.y; r <= rw.getRows(); r++)
                    {
                        ...
                        for (int c = colStart; c <= rw.getCols(); c++)
                        {
							...
							if(o != null)
							{
								String value = ResultProcessor.columnValueToString(o);
    ...
    protected class AllSelector extends Thread
    {
        ...
        public void copyAll()
        {
            ...
            Controller.trace(5, "initial free memory:" + initFree);
            try
            {
                buf.append("\n");
                rw.getResultSet().beforeFirst();
                ...
                while (copyRuns && rw.getResultSet().next())
                {
                    ...
                    buf.append("\n");
                    //Controller.trace(5, "free memory diff:" + (initFree - rt.freeMemory()));
            ...
            finally
            {
                ...
                copyRuns = false;
                saveListener.saveFinished();
                Controller.trace(5, "select all finished.");
            }
        }
    ...
    public class TableModel extends AbstractTableModel
    {
       ...
       private ResultWrapper wrapper = null;
       ...
       public TableModel(ResultWrapper rw)
       {
       ...
       public int getColumnCount()
       {
         ...
         public Object getValueAt(int row, int col)
         {
           ...
           if(invokations == 100)
           {
               Controller.trace(5, "cache success factor:" + inCache + "%");
               invokations = 0;
               inCache = 0;
           }
           if(o != null)
